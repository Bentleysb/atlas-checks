...
public class InvalidLanesTagCheck extends BaseCheck
{
    ...
    private static final long EXCLUDE_ONEWAY_MINIMUM_DEFAULT = 11;

    private final TaggableFilter lanesFilter;

    private final long excludeOnewayMinimum;
    ...
    public InvalidLanesTagCheck(final Configuration configuration)
    {
        ...
        this.excludeOnewayMinimum = (long) configurationValue(configuration,
                "exclude-oneway.minimum", EXCLUDE_ONEWAY_MINIMUM_DEFAULT);
    }
